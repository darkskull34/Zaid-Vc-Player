...
def play_markup(videoid, user_id):
    buttons= [
            ...
            [
                InlineKeyboardButton(text=f"✨ ɢʀᴏᴜᴘ", url=f"https://t.me/{athal_pamanaihode}"),
                InlineKeyboardButton(text=f"📣 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/{athal_pamanai_hode}"),
            ],
            [      
...
def others_markup(videoid, user_id):
    buttons= [
            [
                InlineKeyboardButton(text="✨ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/{athal_pamanai_hode}"),
